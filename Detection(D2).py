...
for p in true_ps:
    avg_wealth, stop_rate, avg_num_trades, std_wealth, quantiles, average_drawdown, average_detection_time, detection_rate = run_many_games(
                1000, 100, p, prior, ps, bad_edge_threshold = 0.5, alpha = 0.8, good_edge_threshold = 0.5, beta = 0.8
                )
    detection_times.append(average_detection_time)
...
# Plot 1: Average Detection Time vs True Edge
