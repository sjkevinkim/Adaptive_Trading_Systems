...
def run_single_simulation(
    ...
    for n in range(n_steps):
        ...
        # Adaptation with Rolling Estimate
        if len(outcomes) == 0:
            recent_p = 0.5
        else:
...
print("\n---Single Simulation Results Fixed vs Half-Kelly vs Rolling---")
...
print("Rolling wealth at final step:", round(rolling_wealth_history[-1], 2))
...
print("\n---Many Simulation Results Fixed vs Half-Kelly vs Rolling---")
